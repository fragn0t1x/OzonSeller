...
def get_color_hex(color_name):
    ...
    color_map = {
        ...
        'зеленый': '#198754', 'green': '#198754',
        'желтый': '#ffc107', 'yellow': '#ffc107',
        'оранжевый': '#fd7e14', 'orange': '#fd7e14',
        'фиолетовый': '#6f42c1', 'purple': '#6f42c1',
        'розовый': '#e83e8c', 'pink': '#e83e8c',
        'бирюзовый': '#20c997', 'turquoise': '#20c997',
        'голубой': '#0dcaf0', 'lightblue': '#0dcaf0',
        'коричневый': '#795548', 'brown': '#795548',
        'серый': '#6c757d', 'gray': '#6c757d', 'grey': '#6c757d',
        'разноцветный': '#ff6b6b', 'multicolor': '#ff6b6b',
        'светло-серый': '#adb5bd', 'lightgray': '#adb5bd',
        'темно-синий': '#1e40af', 'darkblue': '#1e40af'
    }
